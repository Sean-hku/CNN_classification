1. Training
(1) Use the excel in [train_result/training_demo/training_demo.csv] to design s series of models.
    (The name of folder and excel should be the same)
(2) Assign the new folder name ["your folder"] in [train_result/config.py]
...
(2) The result of each model will be gathered in [weight/"your folder"/"each ID"/"each ID"].
(3) The models are stored in [weight/"your folder"/"each ID"/"each ID"].
(4) Use [train_result/collect_result.py] can gathered the results of each model.
